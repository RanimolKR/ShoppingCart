<cfcomponent>
  ...
  <cfset this.loginPage = '/onlinepedika/login.cfm'>
  <cfset this.cartpage = './shoppingcart.cfm'>
  <cfset this.billingpage = '/onlinepedika/shoppingcart.cfm'>
  <cfset this.component1 = '/onlinepedika/action/components/storedProcedures.cfc'>
  <cfset this.component2 = '/onlinepedika/components/storedProcedures.cfc'>
  <cfset this.component3 = '/onlinepedika/components/billing.cfc'>
