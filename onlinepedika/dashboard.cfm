...
<cfset brands=obj.getFilterItems()> 
                ...
                <div class="filter-column ">
                    <form method="post" action="">
                        ...
                        <div class="brand-options" id="brand-options">
                            <cfoutput>
                                <cfloop query="brands" group="brandName">
                                    <div class="form-check" id="bfilters">
                                        <input type="checkbox" class="form-check-input" name="brand" value="#brandId#" id="#brandName#">
                                    ...
                                    <div class="variant">
                                        <cfloop group="productName">
                                            <div class="form-check"  id="pfilters">
                                                <input type="checkbox" class="form-check-input" name="product" value="#pk_productId#" id="#productName#">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    #productName#
                                                </label><br>
                                            </div>
                                            <cfloop query="brands" >
                                                <cfif !arrayContains(checkColor, colorName) >
                                                    ...
                                                    <div class="form-check" id="cfilters">
                                                        <input  type="checkbox" class="form-check-input" name="color" value="#pk_colorTableId#" id="#colorName#">
                                                        <label class="form-check-label" for="flexCheckDefault">
                                                            #colorName#
                                                        </label>
                                                    </div>
